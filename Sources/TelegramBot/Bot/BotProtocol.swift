...
public protocol BotProtocol {
    ...
    @discardableResult func getUpdates(params: GetUpdatesParams?) throws -> EventLoopFuture<[Update]>

    @discardableResult func setWebhook(params: SetWebhookParams) throws -> EventLoopFuture<Bool>

    @discardableResult func deleteWebhook(params: DeleteWebhookParams?) throws -> EventLoopFuture<Bool>
    ...
    @discardableResult func logOut() throws -> EventLoopFuture<Bool>

    @discardableResult func close() throws -> EventLoopFuture<Bool>
    ...
    @discardableResult func sendPhoto(params: SendPhotoParams) throws -> EventLoopFuture<Message>
    ...
    @discardableResult func sendVoice(params: SendVoiceParams) throws -> EventLoopFuture<Message>

    @discardableResult func sendVideoNote(params: SendVideoNoteParams) throws -> EventLoopFuture<Message>

    @discardableResult func sendMediaGroup(params: SendMediaGroupParams) throws -> EventLoopFuture<[Message]>

    @discardableResult func sendLocation(params: SendLocationParams) throws -> EventLoopFuture<Message>

    @discardableResult func editMessageLiveLocation(params: EditMessageLiveLocationParams) throws
        -> EventLoopFuture<MessageOrBool>

    @discardableResult func stopMessageLiveLocation(params: StopMessageLiveLocationParams?) throws
        -> EventLoopFuture<MessageOrBool>
    ...
    @discardableResult func sendPoll(params: SendPollParams) throws -> EventLoopFuture<Message>
    ...
    @discardableResult func getUserProfilePhotos(params: GetUserProfilePhotosParams) throws
        -> EventLoopFuture<UserProfilePhotos>

    @discardableResult func getFile(params: GetFileParams) throws -> EventLoopFuture<File>

    @discardableResult func banChatMember(params: BanChatMemberParams) throws -> EventLoopFuture<Bool>

    @discardableResult func unbanChatMember(params: UnbanChatMemberParams) throws -> EventLoopFuture<Bool>

    @discardableResult func restrictChatMember(params: RestrictChatMemberParams) throws -> EventLoopFuture<Bool>
    ...
    @discardableResult func createChatInviteLink(params: CreateChatInviteLinkParams) throws -> EventLoopFuture<Bool>

    @discardableResult func editChatInviteLink(params: EditChatInviteLinkParams) throws -> EventLoopFuture<Bool>

    @discardableResult func revokeChatInviteLink(params: RevokeChatInviteLinkParams) throws -> EventLoopFuture<Bool>

    @discardableResult func approveChatJoinRequest(params: ApproveChatJoinRequestParams) throws -> EventLoopFuture<Bool>

    @discardableResult func declineChatJoinRequest(params: DeclineChatJoinRequestParams) throws -> EventLoopFuture<Bool>

    @discardableResult func setChatPhoto(params: SetChatPhotoParams) throws -> EventLoopFuture<Bool>

    @discardableResult func deleteChatPhoto(params: DeleteChatPhotoParams) throws -> EventLoopFuture<Bool>
    ...
    @discardableResult func answerCallbackQuery(params: AnswerCallbackQueryParams) throws -> EventLoopFuture<Bool>

    @discardableResult func setMyCommands(params: SetMyCommandsParams) throws -> EventLoopFuture<Bool>

    @discardableResult func deleteMyCommands(params: DeleteMyCommandsParams?) throws -> EventLoopFuture<Bool>

    @discardableResult func getMyCommands(params: GetMyCommandsParams?) throws -> EventLoopFuture<[BotCommand]>

    @discardableResult func setChatMenuButton(params: SetChatMenuButtonParams?) throws -> EventLoopFuture<Bool>

    @discardableResult func getChatMenuButton(params: GetChatMenuButtonParams?) throws -> EventLoopFuture<MenuButton>

    @discardableResult func setMyDefaultAdministratorRights(params: SetMyDefaultAdministratorRightsParams?) throws
        -> EventLoopFuture<Bool>

    @discardableResult func getMyDefaultAdministratorRights(params: GetMyDefaultAdministratorRightsParams?) throws
        -> EventLoopFuture<ChatAdministratorRights>

    @discardableResult func editMessageText(params: EditMessageTextParams) throws -> EventLoopFuture<MessageOrBool>

    @discardableResult func editMessageCaption(params: EditMessageCaptionParams?) throws
        -> EventLoopFuture<MessageOrBool>

    @discardableResult func editMessageMedia(params: EditMessageMediaParams) throws -> EventLoopFuture<MessageOrBool>

    @discardableResult func editMessageReplyMarkup(params: EditMessageReplyMarkupParams?) throws
        -> EventLoopFuture<MessageOrBool>

    @discardableResult func stopPoll(params: StopPollParams) throws -> EventLoopFuture<Poll>

    @discardableResult func deleteMessage(params: DeleteMessageParams) throws -> EventLoopFuture<Bool>
    ...
    @discardableResult func getCustomEmojiStickers(params: GetCustomEmojiStickersParams) throws
        -> EventLoopFuture<[Sticker]>

    @discardableResult func uploadStickerFile(params: UploadStickerFileParams) throws -> EventLoopFuture<File>
    ...
    @discardableResult func answerInlineQuery(params: AnswerInlineQueryParams) throws -> EventLoopFuture<Bool>
    ...
    @discardableResult func createInvoiceLink(params: CreateInvoiceLinkParams) throws -> EventLoopFuture<String>

    @discardableResult func answerShippingQuery(params: AnswerShippingQueryParams) throws -> EventLoopFuture<Bool>

    @discardableResult func answerPreCheckoutQuery(params: AnswerPreCheckoutQueryParams) throws -> EventLoopFuture<Bool>

    @discardableResult func setPassportDataErrors(params: SetPassportDataErrorsParams) throws -> EventLoopFuture<Bool>
