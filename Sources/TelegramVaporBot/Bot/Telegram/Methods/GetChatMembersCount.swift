...
// This file is autogenerated by API/generate_wrappers.rb script.import Vapor

/// Parameters container struct for `getChatMembersCount` method
public struct GetChatMembersCountParams: Encodable {
...
public extension Bot {
    ...
    @discardableResult func getChatMembersCount(params: GetChatMembersCountParams) throws -> EventLoopFuture<Int> {
