...
extension AsyncClientProtocol {
    @discardableResult
    public func get<Params: Encodable, Response: Codable>(_ url: URI, params: Params?, as mediaType: Vapor.HTTPMediaType?) -> EventLoopFuture<Response> {
    ...
    @discardableResult
    public func post<Params: Encodable, Response: Codable>(_ url: URI, params: Params?, as mediaType: Vapor.HTTPMediaType?) -> EventLoopFuture<Response> {
        let promise = client.eventLoop.makePromise(of: Response.self)
        promise.completeWithTask {
